...
created: 30.09.2024 | [updated](https://github.com/jochen-hanisch/research):  | [published]():  | [Austausch](https://github.com/jochen-hanisch/research/discussions) | [[Hinweise]]
...
```mermaid
flowchart TD
    A[Fraktale Didaktik] --> B[Unsicherheitskorrelationen]
    B --> C[Fraktale Strukturen im Bildungsraum]
    C --> D[Elementaroperationen: Feedback, Reflexion, Re-Entry]
    D --> E[Stabilität und Dynamik im Bildungssystem]

    A1[Exziton-Dynamik] --> B1[Korrelationen: Ladung, Spin, Pseudo-Spin]
    B1 --> C1[Fraktale Strukturen im Quanten-Hall-System]
    C1 --> D1[Topologische Stabilität und Phasenübergänge]

    E --> F[Systemübergreifende Prinzipien]
    D1 --> F
    F --> G[Höhere Systemebene: Universelle Prinzipien]
...
mindmap
  root((Erkenntnisse))
    ...
    Physiksystem
      ...
      Füllungsfaktor
    Gemeinsamkeiten
      Korrelationen als fraktale Generatoren
...
```mermaid
quadrantChart
    title Vergleich der Funktionen von nu
    x-axis Stabilitaet --> Dynamik
    y-axis Bildung --> Physik
    quadrant-1 Bildungsorientiert und Stabil
    quadrant-2 Bildungsorientiert und Dynamisch
    quadrant-3 Physikorientiert und Stabil
    quadrant-4 Physikorientiert und Dynamisch
    Bildungswirkfaktor_Stabilitaet: [0.2, 0.8]
    Bildungswirkfaktor_Dynamik: [0.5, 0.7]
    Bildungswirkfaktor_Uebergaenge: [0.7, 0.9]
    Fuellungsfaktor_Stabilitaet: [0.2, 0.3]
    Fuellungsfaktor_Dynamik: [0.5, 0.2]
    Fuellungsfaktor_Uebergaenge: [0.7, 0.4]
