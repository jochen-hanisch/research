...
```mermaid
flowchart TD
 Start(["Start des Lernprozesses<br>Neue Karten im Stapel"]) --> Lernen["Lernen der neuen Karten"]
 Lernen --> Feedback{"Gekonnt?"}
 
 Feedback -->|Richtig| Fach1(["Karte wandert in Fach 1"])
 Feedback -->|Falsch| StapelZurueck["Karte zurück auf den Stapel<br>zu lernender Karten"]
 
 Fach1 --> Fach1Wiederholen(["Tägliche Wiederholung<br>in Fach 1"]) --> Fach1Feedback{"Gekonnt?"}
 Fach1Feedback -->|Richtig| Fach2(["Wandert in Fach 2"])
 Fach1Feedback -->|Falsch| StapelZurueck
 
 Fach2 --> Fach2Check{"Fach 2 voll?"}
 Fach2Check -->|Ja| Fach2Wiederholen(["Wiederholung Fach 2"])
 Fach2Check -->|Nein| Fach2["Weitere Karten in Fach 2"]
 Fach2Wiederholen --> Fach2Feedback{"Gekonnt?"}
 Fach2Feedback -->|Richtig| Fach3(["Wandert in Fach 3"])
 Fach2Feedback -->|Falsch| StapelZurueck
 
 Fach3 --> Fach3Check{"Fach 3 voll?"}
 Fach3Check -->|Ja| Fach3Wiederholen(["Wiederholung Fach 3"])
 Fach3Check -->|Nein| Fach3["Weitere Karten in Fach 3"]
 Fach3Wiederholen --> Fach3Feedback{"Gekonnt?"}
 Fach3Feedback -->|Richtig| Fach4(["Wandert in Fach 4"])
 Fach3Feedback -->|Falsch| StapelZurueck
 
 Fach4 --> Fach4Check{"Fach 4 voll?"}
 Fach4Check -->|Ja| Fach4Wiederholen(["Wiederholung Fach 4"])
 Fach4Check -->|Nein| Fach4["Weitere Karten in Fach 4"]
 Fach4Wiederholen --> Fach4Feedback{"Gekonnt?"}
 Fach4Feedback -->|Richtig| Fach5(["Wandert in Fach 5"])
 Fach4Feedback -->|Falsch| StapelZurueck
 
 Fach5 --> Fach5Check{"Fach 5 voll?"}
 Fach5Check -->|Ja| Fach5Wiederholen(["Wiederholung Fach 5"])
 Fach5Check -->|Nein| Fach5["Weitere Karten in Fach 5"]
 Fach5Wiederholen --> Fach5Feedback{"Gekonnt?"}
 Fach5Feedback -->|Richtig| Archiv(["Archiv: Karte gelernt"])
 Fach5Feedback -->|Falsch| StapelZurueck
 
 Archiv --> Ende(["Erfolg: Karte abgeschlossen"])
 
 class Start,Ende,Archiv startEnd
 class Lernen,StapelZurueck process
 class Feedback,Fach1Feedback,Fach2Feedback,Fach3Feedback,Fach4Feedback,Fach5Feedback,Fach2Check,Fach3Check,Fach4Check,Fach5Check decision
 class Fach1,Fach2,Fach3,Fach4,Fach5 process
 class Fach1Wiederholen,Fach2Wiederholen,Fach3Wiederholen,Fach4Wiederholen,Fach5Wiederholen repeat
