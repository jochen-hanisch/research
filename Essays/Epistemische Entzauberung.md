...
Die vorliegende Essey geht aus einer persönlichen, alltäglichen Ausgangssituation hervor, dem erstmaligen gemeinsamen Ansehen eines Harry-Potter-Films mit meiner neunjährigen Tochter. Entwickelte sich durch algorithmisch verstärkten Social-Media-Content in der darauffolgenden Zeit zu einem erkenntnisgetriebenen Reflexionsprozess. Die Timeline füllte sich mit Szenen, Theorien, Zitaten; eine Vielzahl kultureller Fragmenttexte, das seit Jahrzehnten Leserinnen und Leser sowie Zuschauerinnen und Zuschauer weltweit bewegt.

Diese unerwartete Konfrontation mit dem Harry-Potter-Universum stellte eine Frage in den Mittelpunkt, die in klassischer Lektüre oder filmischer Rezeption selten explizit wird:
...
Ziel dieser Arbeit ist infolgedessen, diese Frage systematisch unter Rückgriff auf systemtheoretische, literaturanalytische und epistemologische Modelle zu durchdringen. Denn vielleicht ist Harry Potter kein klassischer Held, sondern eine Funktion. Nicht das narrative Zentrum, sondern die strukturelle Bedingung kommunikativer Prozesse.
...
flowchart TD
    ...
    B["**Lily**<br>_epistemische Setzung_"]
...
Die Abbildung 1 visualisiert die funktionalen Relationen der zentralen Figuren im narrativen Netzwerk von Harry Potter als systemisches Kommunikationsdiagramm. Die dargestellten Knoten repräsentieren Figuren, die im Text nicht als psychologisch motivierte Subjekte, sondern als systemisch definierte Operationen interpretiert werden. Die farbliche Gruppierung signalisiert funktionale Differenzierungen: Das „Kernsystem“ (beige) umfasst zentrale strukturkonstitutive Rollen (Snape, Lily, Dumbledore, Harry), die den grundlegenden Sinnhorizont präfigurieren. Die „Rahmenfiguren“ (hellblau) markieren unterstützende oder spiegelnde Instanzen, die Resonanz- und Reflexionsbewegungen ermöglichen (Ron, Hermine, Ginny). Die „Gegenspielerfigur“ (rosa) Voldemort verkörpert systemische Störung und narrative Eskalation.

Die Pfeilrichtungen deuten nicht auf psychologische Beziehungen, sondern auf funktionale Wirkpfade hin. Sie markieren Prozesse symbolischer Codierung, Rekursion, semantischer Spiegelung und struktureller Differenz. Die doppelt gerichteten Pfeile kennzeichnen rekursive Zirkulationen (z. B. zwischen Harry und Hermine), während einfache Richtungen symbolische Initiationen oder strukturelle Setzungen anzeigen (z. B. Lily → Dumbledore). Die Abbildung konkretisiert damit die Annahme, dass die erzählerische Logik des Harry-Potter-Universums nicht durch individuelle Handlungen getragen wird, sondern durch systemische Anschlussfähigkeit – operationalisiert über Kommunikationsfiguren, symbolische Setzungen und rekursive Rückbindungen.

Diese Erkenntnis führt zu einer grundlegenden Verschiebung der Analyse: Nicht die psychologische Tiefe oder individuelle Entwicklung der Figuren steht im Vordergrund, sondern deren strukturelle Funktionalität innerhalb eines kommunikativen Systems. Die zentrale These lautet: Harry Potter ist nicht der Held im klassischen Sinne, sondern eine Kommunikationsfigur, die das narrative System erst ermöglicht und stabilisiert. Diese Hypothese bildet den Ausgangspunkt für die weitere Untersuchung und wird im folgenden Abschnitt systematisch entfaltet.
...
In dieser Perspektive übersteigt die Kommunikationsfigur das klassische Heldenmodell (Campbell, 2008) nicht durch Intensität, sondern durch strukturelle Reichweite. Sie ist keine Figur der inneren Wandlung, sondern eine Bedingung narrativer Emergenz: ein Resonanzraum kollektiver Zuschreibungen, ein Verdichtungsort symbolischer Ordnung, ein Beobachtungspunkt systemischer Selbstbeschreibung (vgl. Barthes, 1977; Luhmann, 1997; Eco, 1979).
...
Ohne diese Codierung gäbe es keine narrative Sonderstellung Harrys, keine symbolische Signatur auf seiner Stirn, keine strukturelle Verbindung zu Voldemort und somit kein anschlussfähiges Zentrum der Erzählung. Der Tod Lilys markiert damit den Punkt, an dem Harry überhaupt erst zur Kommunikationsfigur werden kann: nicht durch Eigenschaft, sondern durch Funktion. Ihre Entscheidung begründet ein semantisches Kraftfeld, das nicht rückblickend interpretiert, sondern voraussetzungsschaffend wirkt – vergleichbar einer Codierung, die die Modalität des gesamten Systems bestimmt.
...
Die strukturale Differenz zwischen diesen Figuren ist nicht narrativ, sondern funktional. Es geht nicht um Handlungsabläufe, sondern um Operationen, die das System ermöglichen, rekonfigurieren oder gefährden. In diesem Sinn markiert jede Figur eine eigene Funktion innerhalb des Kommunikationsraums. Das Zentrum Harry wird nicht von innen her mit Sinn gefüllt, sondern von außen durch Operationen umcodiert. 
...
Die abschließende Reflexion verdichtet die vorangegangene Analyse zu einer letzten epistemischen Bewegung: Welche Konsequenzen ergeben sich aus der Rekonstruktion des Harry-Potter-Universums als symbolisch operierendes Kommunikationssystem? Was bleibt, wenn sich magische Figuren in strukturelle Funktionen auflösen – und sich Resonanzräume in systemische Netzwerke verwandeln? Die Frage zielt nicht auf den Wertverlust der Erzählung, sondern auf ihren epistemischen Umbau: von der Mythologie zur Struktur, vom Subjekt zur Semantik.
