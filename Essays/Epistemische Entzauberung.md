...
```mermaid
flowchart TD
  %% Knoten (Figuren als systemische Operationen)
  A["Snape<br><i>Semantik<br>der<br>Verdrängung</i>"]
  B["Lily<br><i>Semantische<br>Initialfigur</i>"]
  C["Dumbledore<br><i>Kontingenzsteuerung</i>"]
  D["Ron<br><i>Affektive<br>Koppelung</i>"]
  E["Hermine<br><i>Epistemische<br>Spiegelstruktur</i>"]
  H["Ginny<br><i>Identifikatorische<br>Rückbindung</i>"]
  F["Harry<br><i>Kommunikationsfigur</i>"]
  G["Voldemort<br><i>Systemstörung<br>durch<br>Exklusion</i>"]

  %% Hauptpfade mit IDs zur Einfärbung
  A -->|implizite<br>Ursprungssemantik| B:::primary
  B -->|initiale<br>Codierung| C:::primary
  C ==> |rekursive<br>Strukturkopplung| A:::secondary
  C -->|probabilistische<br>Steuerung| D:::primary
  D -->|affektive<br>Resonanz| E:::primary
  E -->|epistemische<br>Refraktion| H:::primary
  H ==> |Rückbindung<br>an<br>Leerstelle| F:::secondary
  F ==> |systemische<br>Differenzierung| G:::primary

  %% Rückkopplungen
  D -->|emotionale<br>Rückkopplung| C:::secondary
  E -->|semantische<br>Spiegelung| F:::secondary
  F -->|reflexive<br>Rekursion| E:::secondary
  G ==> |disruptive<br>Setzung| B:::primary

  %% Stildefinitionen CI-konform
  classDef kern fill:#006666,stroke:#663300,stroke-width:2px,color:#ffffff;
  classDef rahmen fill:#66CCCC,stroke:#cc6600,stroke-width:2px,color:#003366;
  classDef gegenspiel fill:#990000,stroke:#000000,stroke-width:2px,color:#ffffff;
  classDef primary stroke:#ff00ff,stroke-width:1.5px;
  classDef secondary stroke:#cc6600,stroke-width:1.5px;
