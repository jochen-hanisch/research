...
created: 21.2.2026 | [updated](): 22.2.2026 | [published](https://zenodo.org/records/18728202): 22.2.2026 | [Austausch](https://github.com/jochen-hanisch/research/discussions) | [[Hinweise]]
...
flowchart TD
    ...
    %% Herleitungsebene
    A[Duden: Ursache → Veränderung] --> B[Hume: keine notwendige Verbindung]
    B --> C[Physik: Wechselwirkung / Relationen]
    C --> D[Systemtheorie: Operation / Irritation]
    D --> E[Spencer Brown / Bateson: Differenz, die Differenz macht]

    %% Strukturkern
    E --> F[Differenz]
    F --> G{Anschluss?}

    G -- nein --> H[Zustandsdifferenz ohne Wirkung]
    G -- ja --> I[Wirkung\nanschlussrelevante Differenz]

    I --> J[Wirken\nprozessuale Entfaltung]
