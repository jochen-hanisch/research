...
bibliography: "/Users/jochen_hanisch-johannsen/Library/Mobile Documents/iCloud~md~obsidian/Documents/Jochen-Hanisch/Allgemein_beruflich/Research/Charité - Universitätsmedizin Berlin/Matadaten/Literaturverzeichnis.bib"
...
Hier kannst du ein manuelles Abkürzungsverzeichnis einfügen.

Bitte fügen Sie an dieser Stelle ein Abkürzungsverzeichnis ein, wenn das aufgrund einer großen Zahl von in der Dissertation verwendeten Abkürzungen erforderlich oder hilfreich erscheint.
\newpage

# Symbolverzeichnis

Hier kannst du ein manuelles Symbolverzeichnis einfügen.
...
Zitat: „Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquid ex ea commodi consequat.“
...
```{=latex}
\begin{figure}[H]  % Beginn der LaTeX-Tabellenumgebung
\centering         % Zentriert die gesamte Tabelle
\includegraphics[width=0.6\textwidth]{"/Users/jochen_hanisch-johannsen/Library/Mobile Documents/com~apple~CloudDocs/Abbildungen/Systemischer-Ansatz.png"}
\caption{ER-Diagramm zum Organisationsmanagement}
\label{fig:er-diagram}
\end{figure}

```

Die Einleitung eröffnet die eigentliche Dissertation und führt in die Thematik ein, legt den Stand der Forschung dar und entwickelt die Fragestellung. Die Einleitung schließt mit der Fragestellung, die in der Promotion bearbeitet wurde, ab. Untergliedern Sie die Einleitung in sinnvolle Unterkapitel. Das letzte Unterkapitel beinhaltet die Fragestellung.

Wie in Abbildung \ref{fig:er-diagram} gezeigt, stellt das Diagramm die Struktur des Organisationsmanagements dar.
...
\begin{figure}[H]  % Beginn der LaTeX-Tabellenumgebung
\centering         % Zentriert die gesamte Tabelle
\includegraphics[width=0.6\textwidth]{"/Users/jochen_hanisch-johannsen/Library/Mobile Documents/com~apple~CloudDocs/Abbildungen/newplot.png"}
\caption{Leeres Bild der Fraktalen Didaktik}
\label{fig:fraktale-didaktik-leer}
\end{figure}

```

Wenn Sie im Manteltext Abbildungen, Tabellen, Texte etc. aus der/n Publikation/en entnehmen, die Sie vorlegen, machen Sie dies bitte durch ein korrektes Zitat kenntlich! Wenn Sie nicht der einzige Autor/die einzige Autorin einer Publikation sind, dürfen Sie die Publikation nicht so behandeln, als wären alle Texte, Abbildungen, Tabellen etc. darin Ihr Eigentum. Sie sind ebenso Eigentum Ihrer Koautor*innen und sind daher wie Fremdzitate zu behandeln. Wenn Sie in der Einleitung Aspekte darstellen, die aus der Publikation entnommen sind, muss die Publikation analog zu anderen Quellen zitiert werden.

Abbildung \ref{fig:fraktale-didaktik-leer} zeigt eindeutig keine Inhalte.
...
Abbildung 1: Doktorhut, Legende, Quellenangabe: xyz
...
\caption{\fontsize{9}{11}\selectfont Übersicht der Berufe}  % Beschriftung auf Schriftgröße 9 pt setzen
\label{tab:uebersicht-berufe}
{\fontsize{8}{10}\selectfont  % Setzt die Schriftgröße innerhalb der Tabelle auf 9 pt
\begin{tabular}{|l|c|l|}
\hline
...
% Zusatzbeschreibung direkt nach der Tabelle
\begin{quote}
\fontsize{8}{10}\selectfont  % Schriftgröße für Zusatzbeschreibung auf eine kleinere Größe setzen
Die obige Tabelle gibt einen Überblick über die beruflichen Hintergründe und Altersgruppen der befragten Personen.
Es ist ersichtlich, dass die Verteilung der Berufe ausgewogen ist, mit einem Fokus auf technische und pädagogische Berufe.
Besonders auffällig ist die Altersverteilung, die eine breite Spanne von 28 bis 45 Jahren umfasst.
\end{quote}
...
\begin{table}[h!]
\centering
\renewcommand{\arraystretch}{1.2}  % Zeilenabstand innerhalb der Tabelle vergrößern
\caption{Preisübersicht der Produkte}  % Setzt die Beschriftung der Tabelle
\label{tab:preisuebersicht}  % Definiert das Label für spätere Verweise
{\fontsize{8}{10}\selectfont  % Setzt die Schriftgröße innerhalb der Tabelle auf 9 pt
\begin{tabular}{|l|r|c|}
\hline
...
Ohne eckige Klammern: Autor (Jahr), bspw. @abdelshaheedDigitalCollaborativeLearning2024

Mit eckigen Klammern: (Autor (Jahr)), bspw. [@engelBildungNaechstenGesellschaft2023]

Zwei Autoren, bspw. @boehmerBlendedLearningMobility2022 und @arnoldSteigendeKomplexitaetBetrieblichen2022 ergeben miteinander das hier: [@boehmerBlendedLearningMobility2022; @arnoldSteigendeKomplexitaetBetrieblichen2022]

Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquid ex ea commodi consequat. @jaeserkatrinRelevanzKompetenzenFuer2023

Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquid ex ea commodi consequat. (@jaeserkatrinRelevanzKompetenzenFuer2023)


Lorem ipsum dolor sit amet @ehlertKurzeRedeLanger2024, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquid ex ea commodi consequat [@heiserSeamlessLearningBildungswissenschaftlichen2021].

Nach @steinlDidaktikUndPaedagogische2020 sind die folgenden Bereiche unstrittig, das einfach nur komisch [@steinlDidaktikUndPaedagogische2020 ]. Allerdings geht es hier weiter.
...
„Ich, Jochen Hanisch-Johannsen, versichere an Eides statt durch meine eigenhändige Unterschrift, dass ich die vorgelegte Dissertation mit dem Thema: [Titel auf Deutsch und Englisch] selbstständig und ohne nicht offengelegte Hilfe Dritter verfasst und keine anderen als die angegebenen Quellen und Hilfsmittel genutzt habe.
...
Folgende Zitiermethoden können verwendet werden:

Vancouver-System (Zahlen-Methode) Von der ICMJE erstelltes System, häufig in der Medizin verwendet. Es liegt den Ausführungen in den Guidelines der National Library of Medicine zugrunde. Ausführliches finden Sie auf der Seite der Bibliothek: https://bibliothek.charite.de/publizieren/informatio-nen_zum_publizieren/

Harvard-Methode (Name-Jahr-System): Ebenfalls oftmals verwendetes System. Nähere Informationen auf der Homepage der Charité Geschäftsstelle GWP
