...
\end{tikzpicture}
\caption*{\footnotesize Zwei Lektürepfade durch Kapitel 7: Der lineare Pfad (schwarz, durchgezogen) führt von der systemischen Positionierung über Synthese, Reflexion und Begrenzung zu Entwicklungsperspektiven. Der explorative Pfad (grau, gestrichelt) verweist auf zirkuläre Rückbindungen: Erkenntnisse modifizieren die Ausgangsposition.}
\caption{Strukturierte Lektürepfade durch Kapitel 7 – linear und explorativ.}
