\begin{figure}[H]
  ...
  \draw[link] (kw1.east) -- (folgen.west);
  \draw[link] (kw2.east) -- (folgen.west);
  \draw[link] (kw3.east) -- (folgen.west);
  \draw[link] (kw4.east) -- (folgen.west);
  \draw[link] (kw5.east) -- (folgen.west);
  \draw[link] (kw6.east) -- (folgen.west);
  \draw[link] (kw7.east) -- (folgen.west);
  \draw[link] (kw8.east) -- (folgen.west);
  \draw[link] (kw9.east) -- (folgen.west);
  \draw[link] (kw10.east) -- (folgen.west);

  \draw[line] (folgen) -- node[right]{nachgelagert} (impl);
  \node[above=2mm of folgen] {Kopplung Schlagworte $\leftrightarrow$ Folgen};
  \end{tikzpicture}
