...
\end{tikzpicture}
\caption*{\footnotesize Zwei Lektürepfade durch Kapitel 6: Der lineare Pfad (schwarz, durchgezogen) zeigt die argumentative Kette von Ergebnisrückbindung über Theoriemodifikation zur Gestaltung. Der systemische Pfad (grau, gestrichelt) betont die Rückkopplung gestalterischer Überlegungen auf theoretische Modelle und Forschungslogik.}
\caption{Strukturierte Lektürepfade durch Kapitel 6 – linear und systemisch (eigene Darstellung).}
