...
\end{tikzpicture}
\caption*{\footnotesize Zwei mögliche Lektürepfade durch Kapitel 5: Der lineare Pfad (schwarz, durchgezogen) rekonstruiert die Ergebnisse entlang ihrer Entfaltung. Der explorative Pfad (grau, gestrichelt) verweist auf interpretative Rückkopplungen – von der Synthese zur Einordnung und zur kategorialen Verteilung.}
\caption{Strukturierte Lektürepfade durch Kapitel 5 – linear und explorativ.}
