...
\end{tikzpicture}
\caption*{\footnotesize Zwei mögliche Lektürepfade durch Kapitel 4: Der lineare Pfad (schwarz, durchgezogen) folgt dem klassischen Forschungsprozess von der erkenntnistheoretischen Rahmung bis zur methodenkritischen Rückkopplung. Der systemische Pfad (grau, gestrichelt) betont zyklische Überprüfungen von Passung, Validität und Modellstimmigkeit.}
\caption{Strukturierte Lektürepfade durch Kapitel 4 – linear und systemisch (eigene Darstellung).}
