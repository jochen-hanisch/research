...
_„Welche Effekt-Faktoren erläutern Lehrende im digitalen Bildungsraum der Gesundheitsberufe bei der Anwendung eines Learning-Management-Systems (LMS)?“_

  

Die Kategorien wurden **deduktiv** (aus Theorie, Metaprompt, FU2b) und **induktiv** (aus wiederkehrenden Mustern in den 27 Analysen) gebildet.
...
3. Ankerbeispiele (paraphrasiert)
...
|---|---|---|---|
|**Didaktisches Design / LMS-Szenarien**|Strukturmerkmale des Lehrdesigns im LMS (Strukturierung, Aufgabenformat, PBL, Simulation, Blended-Learning-Konfiguration).|„Blended Learning mit Supervision führt zu besseren praktischen Ergebnissen“ (Engert et al., 2025).|Kodieren, wenn Lehrende beschreiben, _wie_ das Design eines Kurses im LMS Effekte erzeugt.|
|**Feedback- und Kooperationsarchitekturen**|Organisierte Interaktionsformen: Peer-Feedback, Peer-Assessment, kollaboratives Schreiben, Storytelling, Gruppenarbeit.|„Kollaboratives Schreiben steigert Interdependenz“ (Compagnoni & Serragiotto, 2024).|Kodieren, sobald soziale Interaktionen im LMS als Wirkfaktor benannt werden.|
|**Learning Analytics / Datenpraxis**|Nutzung von Dashboards, Logdaten, Risikoidentifikation, Monitoring.|„Multifunktionale LA-Interventionen verbessern Lernergebnisse“ (Pan et al., 2024).|Kodieren, wenn Daten aus LMS für Entscheidungen oder Anpassungen genutzt werden.|
|**Technische Infrastruktur / Systemqualität**|Stabilität, Zugang, Bandbreite, Tool-Kompatibilität, Geräte.|„Unzureichende Infrastruktur verursacht Belastung“ (Annemann et al., 2024).|Kodieren, wenn Lehrende auf technische Bedingungen verweisen, die Effekte beeinflussen.|

---

## **2. Effekte (Wirkungsebene)**

|**Kategorie**|**Definition**|**Ankerbeispiele**|**Kodierregel**|
|---|---|---|---|
|**Lernprozesse / Kompetenzentwicklung**|Wahrgenommene Effekte auf Wissen, Skills, Selbstregulation, Transfer.|„Microlearning erhöht VC-Kompetenzen signifikant“ (Liew et al., 2023).|Kodieren, wenn Lehrende konkrete Veränderungen bei Lernenden durch das LMS beschreiben.|
|**Soziale Interaktion / Interdependenz / Teamkognition**|Kooperation, Verantwortungsübernahme, Peer-Dynamiken.|„Peer-Feedback korreliert mit höherer Leistung“ (Viberg et al., 2024).|Kodieren, wenn soziale Prozesse als Effekte beschrieben werden.|
|**Motivation / Selbstwirksamkeit der Lernenden**|Auswirkungen auf Engagement, Aktivität, Motivation.|„E-Portfolios fördern Reflexion und Eigenverantwortung“ (Gittinger & Eckenbach, 2024).|Kodieren, wenn Lehrende Motivation als Wirkung eines LMS-Settings einstufen.|
|**Beanspruchung, Technostress, Belastung**|Psychische, zeitliche oder technische Belastungen durch LMS.|„Techno-overload führt zu Burnout-Risiko“ (Bail et al., 2024).|Kodieren, wenn Belastung als Effekt oder Nebenwirkung benannt wird.|

---

## **3. Lehrendenbezogene Faktoren (Akteursebene)**

|**Kategorie**|**Definition**|**Ankerbeispiele**|**Kodierregel**|
|---|---|---|---|
|**Haltung, Motivation, Erwartungen**|Einstellungen, Selbstwirksamkeit, Offenheit, Pygmalion-Effekte.|„Erwartungen der Studierenden beeinflussen Emotionen der Lehrenden“ (Hackbart & Thies, 2024).|Kodieren, wenn persönliche Einstellung oder Erwartungsdynamik thematisiert wird.|
|**Technisch-didaktische Kompetenzen / TPACK**|Fähigkeit, Technologie, Didaktik und Fachlichkeit zu verknüpfen.|„Fortbildungen mit TPACK-Bezug führen zu höherer Kompetenz und Qualität“ (Runge et al., 2024).|Kodieren, wenn Lehrende techn.-didaktische Fähigkeiten als Wirkfaktor benennen.|
|**Rollenverständnis / Rollenwandel**|Verschiebung vom Instrukteur zur Lernbegleitung, Feedbackdesigner_in, Dateninterpret_in.|„Lehrende gestalten kooperative Lernprozesse statt Inhalte zu vermitteln“ (DPBL-Studien).|Kodieren, wenn die Selbstbeschreibung oder Rolle des Lehrenden im Fokus steht.|

---

## **4. Kontextbedingungen (Organisationsebene)**

|**Kategorie**|**Definition**|**Ankerbeispiele**|**Kodierregel**|
|---|---|---|---|
|**Unterstützungsstrukturen / Fortbildung / Coaching**|Fortbildungen, Support, kollegiale Netzwerke, IT-Support.|„Coach-unterstützte Trainings steigern Completion und Lernleistung“ (Mathur et al., 2023).|Kodieren, wenn organisationale Unterstützung als Ermöglichungsfaktor erscheint.|
|**Arbeitsbedingungen / zeitliche Ressourcen**|Freiräume, Workload, digitale Mehrbelastung.|„Erhöhte Anforderungen durch Online-Lernen führen zu Erschöpfung“ (Richards & Thompson, 2023).|Kodieren, wenn Arbeitsorganisation oder Belastung als Kontextfaktor auftaucht.|
|**Organisationskultur / Führung**|Haltung der Leitung, kollegiale Unterstützung, Fehlerkultur.|„Offenes Kollegium und Schulleitung reduzieren Beanspruchung“ (Annemann et al., 2024).|Kodieren, wenn Kultur- oder Führungsaspekte Effekte beeinflussen.|

---

# **Kurzfassung der Oberkategorien**
...
2. **Effekte (Wirkungsebene):**
    ...
    – Belastung / Technostress
    
3. **Lehrendenfaktoren (Akteursebene):**
...
Das Codiersystem bildet die vollständige Grundlage für die Analyse der FU2b und ist strukturell kompatibel mit der Mayring-Systematik (Kategorienbildung, Definitionsregeln, Ankerbeispiele, Kodierregeln).
