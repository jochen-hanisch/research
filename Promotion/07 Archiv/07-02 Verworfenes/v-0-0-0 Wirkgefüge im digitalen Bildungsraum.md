...
- [ ] ins perfekt setzten, da Ergebnis im Vordergrund steht
...
## 2.2 Didaktisch-praktische Verortung
...
## 3.3 Moodle®-Architektur als Learning-Management-System
Text

## 3.4 Moodle®-Architektur als Arbeits- und Organisationsinstrument 
Text

## 3.5 Ergänzung: Exarbis® als ePortfolio
Text
...
## 4.2 Auswahl und Begründung des Forschungsstils

    
    - Begründung für die Wahl der Methoden und des Forschungsstils im transdisziplinären Kontext.

## 4.3 Datenerhebung

### 4.3.1 Medizinische Datenerhebung

Methoden zur Erhebung der medizinisch relevanten Daten.

### 4.3.2 Bildungswissenschaftliche Datenerhebung

Erhebung der bildungswissenschaftlich relevanten Daten.
## 4.4 Datenauswertung
