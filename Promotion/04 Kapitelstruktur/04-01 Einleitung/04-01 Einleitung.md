...
Die Struktur der Arbeit erlaubt unterschiedliche Formen der Annäherung. Neben der sequenziellen Lektüre bietet sich ein Zugang an, der bei den Ergebnissen einsetzt und von dort aus schrittweise Bezüge herstellt. Die Abbildung (\ref{fig:lesepfad-entdeckend}) visualisiert diesen explorativen Lesepfad und macht die rekursive Anlage der Untersuchung als Bewegung nachvollziehbar. Als Orientierung dienen insbesondere \hyperref[sec:Ergebnisse]{Kapitel 5 (Ergebnisse)}, \hyperref[sec:Forschungsgegenstand]{Kapitel 3 (Forschungsgegenstand)}, die Dynamikperspektive in \hyperref[sec:Regeneration-Stoerung]{Regeneration, Störung und Wirkungskurven}, die Datenanalyse in \hyperref[sec:Datenanalyse]{Kapitel 4.3} sowie die Verdichtung in \hyperref[sec:Diskussion-Interdependenz]{Abschnitt 6.3.1} und \hyperref[sec:Conclusio-Manifest]{Kapitel 7.1}.
