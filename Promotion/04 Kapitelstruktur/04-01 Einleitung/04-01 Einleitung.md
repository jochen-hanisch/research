...
Abbildung \ref{fig:lms-gruende-statista} macht sichtbar, welche Motive Unternehmen mit LMS‑Einsatz bzw. -Einführung verbinden. Dieser Befund ist kein Wirkungsbeleg für Lernprozesse, sondern dient hier als Orientierungsfolie: Wenn LMS primär mit Selbststeuerung (verstanden als eigenständige Planung, Steuerung und Reflexion von Lern- und Übungsprozessen durch die Lernenden), Prozessautomatisierung und regelgebundener Verlässlichkeit verknüpft werden, stellt sich für den untersuchten Ausbildungskontext der zu prüfende Gedanke, ob (und wie) solche Zwecksetzungen in eine didaktische und organisationale Architektur übersetzt werden können, die Rückkopplung, Koordination und Selbststeuerung tatsächlich trägt. Die Arbeit macht diese Übersetzung im Fallbeispiel (Kapitel 3–5) explizit und überprüfbar.
