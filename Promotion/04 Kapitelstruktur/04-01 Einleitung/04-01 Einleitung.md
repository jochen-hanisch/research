...
![Gründe für die Nutzung bzw. Einführung von Learning-Management-Systemen (Deutschland; 2022; Anteil der Befragten). Quelle: eLearning Journal; © Statista 2024.](<08 Metaquellen/08-01 Abbildungen/statistik/Statista - 2024 - Aus welchen Gründen setztplant Ihr Unternehmen ein LMS ein(zusetzen).png>){#fig:lms-gruende-statista}

Die Abbildung macht sichtbar, welche Motive Unternehmen mit LMS‑Einsatz bzw. -Einführung verbinden (Abbildung @fig:lms-gruende-statista). Dieser Befund ist kein Wirkungsbeleg für Lernprozesse, sondern dient hier als Orientierungsfolie: Wenn LMS primär mit Selbststeuerung (verstanden als eigenständige Planung, Steuerung und Reflexion von Lern- und Übungsprozessen durch die Lernenden), Prozessautomatisierung und regelgebundener Verlässlichkeit verknüpft werden, stellt sich für den untersuchten Ausbildungskontext die zu prüfende Leitfrage, ob (und wie) solche Zwecksetzungen in eine didaktische und organisationale Architektur übersetzt werden können, die Rückkopplung, Koordination und Selbststeuerung tatsächlich trägt. Die Arbeit macht diese Übersetzung im Fallbeispiel (Kapitel 3–5) explizit und überprüfbar.
