...
Die Auswahl- und Ausschlusskriterien greifen damit schon vor dem eigentlichen Screening. Berücksichtigt werden nur Quellen, die einen erkennbaren Bezug zu digitalen Bildungsräumen, Learning-Management-Systemen oder funktional angrenzenden Lernsettings haben und bibliografisch ausreichend erschlossen sind. Ausgeschlossen werden Dubletten, bereits negativ codierte Einträge (`Promotion:Ausschluss`), Treffer aus logisch übergeordneten oder bereits abgearbeiteten Sammlungen sowie Titel, die weder auf Titel- noch auf Abstract-Ebene einen tragfähigen Bezug zu den Forschungsunterfragen erkennen lassen. Fehlt der Volltext, kann eine Quelle die Suchstrategie noch anregen, sie wird aber nicht in den analytischen Hauptkorpus übernommen. Die Suchordner leisten damit eine erste, kontrollierte Vorsortierung; das eigentliche methodische Qualitätsfiltering erfolgt erst im anschließenden dreistufigen Screening aus Titel-, Abstract- und Volltextprüfung [@doring_forschungsmethoden_2023, Kapitel 10.6].

Für die Methodologie ist daran vor allem eines wichtig: Die Suchordner bilden den ersten operativen Schritt der forschungsfragengeleiteten Korpusbildung. Sie entscheiden mit darüber, welche Literatur mit welcher Priorität in die Analyse gelangt, und bilden damit die Brücke zur Korpusdiagnostik in Abschnitt~\hyperref[sec:Visualisierungen-Literaturbasis]{4.2.3}, zur Auswertung in Abschnitt~\hyperref[sec:Datenanalyse]{4.3} und zur späteren FU-bezogenen Triangulation. Die Suchordnerlogik gehört deshalb zur methodischen Nachvollziehbarkeit des gesamten Designs: Sie macht den Übergang von einer offenen Recherche zu einem kontrolliert aufgebauten, analysierbaren Literaturfeld explizit.
