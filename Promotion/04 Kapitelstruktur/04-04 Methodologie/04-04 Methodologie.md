...
Für den Literaturkorpus in Abschnitt~\hyperref[sec:Korrelations-Cluster]{4.3.8} wurde beispielhaft mit $k = 4$, 20 Random Starts und Standard-Lloyd-Iteration gearbeitet; der zugehörige Silhouette-Score lag bei $S \approx 0{,}9884$. Die Platzierung dieser Verfahrensbeschreibung in Abschnitt~\hyperref[sec:mdaCV]{4.3.5} ist bewusst gewählt, weil sie die technische Grundlage der mdaCV erläutert; in der späteren Synthese wird nur noch auf ihre Funktion im Gesamtzusammenhang zurückverwiesen.
