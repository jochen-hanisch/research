...
Für die anschließende Darstellung der Forschungslage wird der strukturierte Korpus als argumentativ begründete Synthese ausgearbeitet, statt Ergebnisse additiv entlang einzelner Studien zu berichten. Orientierung bietet dabei die Literaturreview-Logik nach Galvan & Galvan, die Literaturarbeit als nachvollziehbaren Prozess des Sammelns, Bewertens, Vergleichens und Verdichtens von Befunden rahmt und damit die Schreibleistung des Reviews methodisch absichert [@galvan_writing_2025]. Die aus Screening und Tagging hervorgehende Review-Matrix (Quelle–Kontext–Methode–Befunde–Limitationen–Beitrag) dient als Arbeitsinstrument, um thematische Cluster zu bilden, Konvergenzen und Divergenzen sichtbar zu machen und daraus konsistente Argumentationslinien abzuleiten. Auf dieser Syntheseebene werden die nachfolgenden Zwischenfazits und Modellannahmen als Schlussfolgerungen aus dokumentierten Mustern im Literaturfeld begründet, nicht als selektive Auswahl einzelner Befunde. Damit ist der Ansatz als systematische Korpusbildung mit narrativer bzw. konzeptioneller Ergebnisintegration ausgewiesen. Der Workflow gewährleistet Transparenz und Reproduzierbarkeit der Korpusbildung, die Interpretation der Befunde bleibt jedoch auf konzeptionelle Verdichtung ausgerichtet und erhebt keine meta-analytischen Effektbehauptungen.
