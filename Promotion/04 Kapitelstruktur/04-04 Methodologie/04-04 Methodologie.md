...
Die folgenden Hinweise bündeln Anforderungen an Nachvollziehbarkeit, Triangulation und Dokumentation. Kapitel 4 stellt die Verfahren daher ausdrücklich als forschungsfragengeleitete Kopplung dar: Datenformen, Auswertungslogiken und Übergänge zwischen den Schritten werden sichtbar gemacht, statt Methoden nur nebeneinander aufzulisten.
...
Für die anschließende Darstellung der Forschungslage wird der strukturierte Korpus als argumentativ begründete Synthese ausgearbeitet, statt Ergebnisse additiv entlang einzelner Studien zu berichten. Als Schreibleitlinie dient die Literaturreview-Logik nach Galvan & Galvan, die Literaturarbeit als nachvollziehbaren Prozess des Sammelns, Bewertens, Vergleichens und Verdichtens von Befunden beschreibt und damit die Review-Schreibleistung methodisch absichert [@galvan_writing_2025]. In dieser Arbeit wird dafür eine Review-Matrix (Quelle–Kontext–Methode–Befunde–Limitationen–Beitrag) als Arbeitsinstrument genutzt, um thematische Cluster zu bilden, Konvergenzen und Divergenzen sichtbar zu machen und daraus konsistente Argumentationslinien abzuleiten. Zwischenfazits und Modellannahmen werden auf dieser Ebene als Schlussfolgerungen aus dokumentierten Mustern begründet – nicht als selektive Auswahl einzelner Befunde. Der Ansatz ist damit als systematische Korpusbildung mit narrativer bzw. konzeptioneller Ergebnisintegration ausgewiesen: Die Korpusbildung ist transparent und reproduzierbar; die Interpretation bleibt auf konzeptionelle Verdichtung ausgerichtet und erhebt keine meta-analytischen Effektbehauptungen.

#todo (#104, 2026-01-03) Review-Matrix (publikationsreif) als Tabelle im Anhang anlegen: Spalten beispielsweise Quelle | Kontext/Setting | Methode/Design | zentrale Befunde | Limitationen/Qualitätsnotizen | Beitrag zu FU/Modell; Ableitung aus Zotero-Export (`keywords`, `annote`) dokumentieren.
...
#todo (#81, 2025-12-25) prüfen ob alle Abbildungen auch eingebunden sind
...
Damit liefert die zweite Ordnung den semantischen Rahmen, in dem die probabilistische Verdichtung der dritten Ordnung operiert: Sie stellt die deduktiven Referenzen bereit, mit denen die P‑QIA‑Cluster benannt, abgegrenzt, theoretisch eingeordnet und mit weiteren Befundlinien wie SWOT oder Korrelationen zusammengeführt werden. Operativ ist die zweite Ordnung dabei kein technischer Input der P‑QIA, sondern ein nachgelagerter Bezugsrahmen für die inhaltliche Einordnung der probabilistisch erzeugten Kategorien.
...
Bereits in der Zusammenstellung der Analyseeinheiten werden bewusste Auswahlentscheidungen getroffen. Dazu gehört etwa, dass Masterarbeiten und reine „graue Literatur“ nicht in alle Clusteranalysen übernommen wurden. Maßgeblich war dabei nicht ein pauschaler Ausschluss einzelner Textsorten, sondern die Frage, welche Materialien für den jeweiligen Analyseschritt eine hinreichend belastbare und vergleichbare Grundlage bieten. Wo formale Qualitätssicherung, bibliografische Erschließung oder Anschlussfähigkeit an die deduktive Korpusstruktur nicht in ausreichendem Maß gegeben waren, wurden solche Materialien für die stärker verdichtenden Auswertungsschritte zurückgestellt. Diese Entscheidungen sind dokumentiert und theoriebezogen begründet; sie dienen damit nicht der nachträglichen Bereinigung unerwünschter Befunde, sondern der kontrollierten Kalibrierung des jeweiligen Analyseformats.
...
Dieses methodische Vorgehen ist darauf ausgerichtet, wissenschaftliche Strenge nicht zu behaupten, sondern über Nachvollziehbarkeit einlösbar zu machen. Die Methoden werden aus den Forschungsunterfragen hergeleitet, in ihrem Geltungsanspruch eingegrenzt und über Dokumentation, Versionierung und Rückbindung an theoretische Begriffe kontrollierbar gehalten. Transparenz entsteht dabei nicht nur durch die Beschreibung der Verfahren, sondern auch durch die Offenlegung ihrer Übergänge, Revisionen und Prüfstellen. Klassische Evaluationslogiken werden als Ordnungsrahmen mitgeführt, zugleich aber an ein Forschungsdesign angepasst, das mit unterschiedlichen Datensorten, Verdichtungsstufen und modellierenden Elementen arbeitet. Die methodische Strenge dieser Arbeit liegt daher vor allem in der expliziten Regelbindung, in der kontrollierten Triangulation und in der fortlaufenden Reflexion darüber, was die einzelnen Verfahren jeweils leisten können und was nicht.
