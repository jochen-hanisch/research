...
Die folgenden Hinweise bündeln Anforderungen an Nachvollziehbarkeit, Triangulation und Dokumentation. Kapitel 4 stellt die Verfahren deshalb als forschungsfragengeleitete Kopplung dar: Datenformen, Auswertungslogiken und Übergänge zwischen den Schritten werden nicht nur benannt, sondern in ihrer Funktion für die Bearbeitung der Forschungsunterfragen erläutert. Der weitere Aufbau folgt dieser Logik. \hyperref[sec:Forschungsparadigma]{Abschnitt 4.1} beschreibt den methodologischen Rahmen, \hyperref[sec:Datenerhebung]{Abschnitt 4.2} die Datenerhebung, \hyperref[sec:Datenanalyse]{Abschnitt 4.3} die Datenanalyse, \hyperref[sec:Simulation-Kompetenzentwicklung]{Abschnitt 4.4} die simulationsgestützte Modellierung und \hyperref[sec:Methoden-Reflexion]{Abschnitt 4.5} die methodische Reflexion.
...
Für das vorliegende Forschungsvorhaben steht nicht die Zuordnung zu einem einzelnen methodologischen Paradigma im Vordergrund, sondern die Frage, wie sich die Forschungsunterfragen gegenstandsangemessen bearbeiten lassen. Gewählt wird deshalb ein forschungsfragengeleiteter, systemisch integrierender Zugriff, der qualitative, quantitative und simulationsbasierte Verfahren über die Logik der Forschungsunterfragen miteinander verbindet. Die nähere Begründung dieses Zugriffs folgt im erkenntnistheoretischen Rahmen von Abschnitt 4.1, in den methodischen Vorüberlegungen von Abschnitt 4.1.1, in der systemischen Integrationslogik von Abschnitt 4.1.2 und anschließend in den Datenerhebungsverfahren von Abschnitt 4.2.
...
Die Vorüberlegung dieses Kapitels besteht daher nicht in der Ausrufung eines neuen Paradigmas, sondern in der Begründung eines gegenstandsangemessenen Methodendesigns. Es anerkennt unterschiedliche Zugänge zur Erforschung sozialer Phänomene und führt sie so zusammen, dass methodische Vielfalt kontrollierbar bleibt und die Auswahl der Verfahren transparent aus den Forschungsfragen hergeleitet werden kann [@mays_quanti_2020, Seite 198-199]. Darauf aufbauend entwickelt Abschnitt 4.1.2 die systemische Ausgestaltung dieses Zugriffs und präzisiert die operative Verbindung zwischen Forschungslogik und Methodenwahl.
...
Für alle übernommenen Quellen wird anschließend ein erstes, manuelles Tagging vorgenommen. Dabei werden unter anderem Suchpfad, Dokumententyp, thematischer Schwerpunkt, Bezug zu Learning-Management-Systemen sowie eine vorläufige Zuordnung zu den Forschungsunterfragen erfasst. Dieses erste Tagging strukturiert das Korpus und legt die Grundlage für die LLM-gestützte Inhaltsanalyse. In einem nächsten Schritt wird jede Quelle in einem standardisierten Prompt-Format mit GPT verarbeitet. Das LLM erstellt eine strukturierte Zusammenfassung, extrahiert Kernaussagen, rekonstruiert die Argumentation, schlägt eine Indexierung zentraler Begriffe vor, ordnet die Quelle thematischen Kategorien zu, nimmt eine explizite Zuordnung (FU) zu den Forschungsunterfragen vor und formuliert eine graduelle Relevanzbewertung. Die theoriebezogene Literaturarbeit erfolgte dabei ausgehend von der bibliographischen Arbeitsgrundlage der Dissertation entlang eines verdichtenden Analyserasters, das Kerngedanke, Argumentationslogik, Schlussfolgerungen und Weiterführung für den Untersuchungsgegenstand erfasste [@galvan_writing_2025; @doring_forschungsmethoden_2023]. Aus diesem Analyseraster heraus wurden die in \hyperref[sec:Bildungswiss-Verortung]{Abschnitt 2.2} und \hyperref[sec:MedienpaedagogischeRahmung]{Abschnitt 2.3} verwendeten Arbeitsbegriffe und Wirkannahmen gegenstandsbezogen gerahmt und für die vorliegende Dissertation weitergeführt. Die LLM-Ausgaben wurden im Lektüreprozess kontrolliert, gegebenenfalls korrigiert und mit den eigenen Einschätzungen abgeglichen. Der hier eingesetzte Workflow ist kompatibel mit dem bei @hebbel-seeger_wissenschaftliches_2025 genannten, vierphasigen KI-gestützten Rechercheverständnis (Themensondierung, Inhaltsauswertung, Wissensorganisation, Spezialrecherche) und versteht den Einsatz von LLM als kognitive Verstärkung bei fortbestehender menschlicher Validierungsverantwortung [@hebbel-seeger_wissenschaftliches_2025, Seite 434-436].
...
Der gesamte Prozess – von Beginn (Google-Alert beziehungsweise zufällige Quelle) über Screening, doppeltes Tagging und LLM-Unterstützung bis hin zu Netzwerk- und Pfadanalysen – ist damit als zirkulärer, transparent dokumentierter Recherche- und Analysepfad angelegt. Er sorgt dafür, dass die in dieser Arbeit entwickelten Aussagen zu digitalen Bildungsräumen auf einem systematisch erschlossenen und strukturell ausgewerteten Literaturfeld beruhen.
...
Die Suchordnerlogik ist entlang primärer, sekundärer und tertiärer Suchbegriffe aufgebaut. Damit werden Kernbezüge, kontextualisierende Nachbarschaften und periphere Trendfelder unterschieden. Die Ordnerkennungen (z. B. `S:01`) entsprechen der Zotero-Struktur und wurden parallel als Tags verwendet, sodass Suchpfad und spätere Auswertung durchgehend aufeinander bezogen bleiben.
...
Die Suchordnerstrategie folgt einer festen Schrittlogik. Zunächst wird ein Suchpfad gewählt, der den semantischen Abstand zum Forschungsgegenstand markiert; anschließend wird der jeweilige Ordner technisch über Eintragstyp, Bool’sche Begriffskombinationen und Sprachvarianten definiert und danach gesichtet. Mit wachsender Distanz zum Kerngegenstand sinkt die Sichtungsquote bewusst, damit der Suchraum für relevante Anschlüsse offen bleibt, ohne das analytische Zentrum zu verwässern. Relevante Titel werden danach in Zotero mit Suchpfad, Dokumenttyp und thematischer Vorzuordnung getaggt und in den in Abschnitt~\hyperref[sec:Systematische-Literaturrecherche]{4.2.1} beschriebenen Screening- und Taggingprozess überführt [@doring_forschungsmethoden_2023, Kapitel 10.6; @galvan_writing_2025].

Damit greifen die Auswahl- und Ausschlusskriterien bereits vor dem eigentlichen Screening. Berücksichtigt werden nur Quellen, die einen erkennbaren Bezug zu digitalen Bildungsräumen, Learning-Management-Systemen oder funktional angrenzenden Lernsettings haben und bibliografisch ausreichend erschlossen sind. Ausgeschlossen werden Dubletten, bereits negativ codierte Einträge (`Promotion:Ausschluss`), Treffer aus logisch übergeordneten oder bereits abgearbeiteten Sammlungen sowie Funde, die weder auf Titel- noch auf Abstract-Ebene einen tragfähigen Bezug zu den Forschungsunterfragen erkennen lassen. Fehlt der Volltext, kann eine Quelle die Suchstrategie noch anregen, wird dabei jedoch nicht in den analytischen Hauptkorpus übernommen. Die Suchordner leisten damit eine erste, kontrollierte Vorsortierung; das eigentliche methodische Qualitätsfiltering erfolgt erst im anschließenden dreistufigen Screening aus Titel-, Abstract- und Volltextprüfung [@doring_forschungsmethoden_2023, Kapitel 10.6].

Für die Methodologie ist daran vor allem wichtig, dass die Suchordner den ersten operativen Schritt der forschungsfragengeleiteten Korpusbildung bilden. Sie entscheiden mit darüber, welche Literatur mit welcher Priorität in die Analyse gelangt, und bilden damit die Brücke zur Korpusdiagnostik in Abschnitt~\hyperref[sec:Visualisierungen-Literaturbasis]{4.2.3}, zur Auswertung in Abschnitt~\hyperref[sec:Datenanalyse]{4.3} und zur späteren FU-bezogenen Triangulation. Die Suchordnerlogik gehört deshalb zur methodischen Prüfbarkeit des gesamten Designs und eröffnet den Übergang von einer offenen Recherche zu einem kontrolliert aufgebauten, analysierbaren Literaturfeld.
...
- **Auswertung:** Deskriptive Kennzahlen pro Dimension, gewichtetes Gesamtmaß gemäß Synopse, Vergleich nach Subgruppen (z. B. Nutzungshäufigkeit, Rolle); fehlende Werte per Listewise/Pairwise je Analyse; Rückbindung an FU$_{1}$/FU$_{2a}$/FU$_{2b}$ und Abgleich mit Eye-Tracking-Befunden [@hanisch-johannsen_wirkgefuge_2025-2].
...
Analog zum Eye‑Tracking [@hanisch-johannsen_wirkgefuge_2025-2] werden die Umfragedaten [@hanisch-johannsen_wirkgefuge_2025] in einem einheitlichen, dokumentierten Schema ausgewertet und für die Triangulation vorbereitet:
...
Damit liefert die zweite Ordnung den semantischen Rahmen, in dem die probabilistische Verdichtung der dritten Ordnung operiert: Sie stellt die deduktiven Referenzen bereit, mit denen die P‑QIA‑Cluster benannt, abgegrenzt, theoretisch eingeordnet und mit weiteren Befundlinien wie SWOT oder Korrelationen zusammengeführt werden. Für die P‑QIA fungiert die zweite Ordnung dabei als nachgelagerter Bezugsrahmen für die inhaltliche Einordnung der probabilistisch erzeugten Kategorien.
