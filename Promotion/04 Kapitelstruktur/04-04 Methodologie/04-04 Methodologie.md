...
\hyperref[tab:cluster_silhouette]{Tabelle~\ref{tab:cluster_silhouette}} dokumentiert die jahresbezogenen Kennwerte der Clusterkohärenz (Fallzahlen, $k$, Silhouette-Score) als Referenz für die nachfolgende Auswertung; die Einordnung erfolgt in Abschnitt \hyperref[sec:Datenanalyse-Grundlogik]{4.3.1}.
...
Die Summenzeile (\hyperref[tab:cluster_silhouette]{Tabelle~\ref{tab:cluster_silhouette}}) dokumentiert die 3 524 für die Kohärenzberechnung herangezogenen Dokumente. Bis 2016 bleiben die Fallzahlen niedrig; die Silhouette-Scores liegen zugleich sehr hoch und sprechen damit für eng fokussierte thematische Ausschnitte. In den Jahren 2018–2022 steigt das Volumen deutlich an, während die Werte weiterhin auf hohem Niveau bleiben ($\geq 0{,}985$). Für die Methodik ist diese Phase vor allem deshalb relevant, weil hier Korpusgröße und Clusterkohärenz vergleichsweise gut zusammenfallen. Der Rückgang auf $0{,}9208$ im Jahr 2024 markiert die stärkste semantische Drift im Beobachtungszeitraum; 2025 deutet sich eine gewisse Rezentrierung an. Insgesamt zeigt die Tabelle, dass hohe Fallzahlen nicht automatisch mit Kohärenzverlust einhergehen, während Wachstumsphasen zugleich besonders vorsichtig interpretiert werden müssen.

Im Zusammenspiel von Silhouette-Scores und Fallzahlen (\hyperref[fig:silhouette-scores]{Abb.~\ref{fig:silhouette-scores}}) lässt sich ablesen, wie sich Volumen und Clusterkohärenz im Literaturfeld zueinander verhalten. Die sehr hohen Werte in den Jahren 2010–2016 sind vor dem Hintergrund kleiner Fallzahlen vorsichtig zu lesen: Sie sprechen eher für eng begrenzte thematische Ausschnitte als für eine allgemeine Stabilität des Gesamtfeldes. Für die Jahre 2018–2022 zeigt sich dagegen eine methodisch interessantere Konstellation, weil hier hohes Volumen mit weiterhin hohen Kohärenzwerten zusammenfällt. Diese Phase kann deshalb als belastbarer Referenzbereich für die spätere Korpusdiagnostik dienen, ohne dass daraus eine inhaltliche Homogenität des gesamten Feldes abgeleitet würde.

Ab 2023 sinkt der Score trotz weiterhin sehr hoher Fallzahlen. Methodisch lässt sich dies als Hinweis auf zunehmende Heterogenität und auf eine Reorganisation des Feldes lesen, etwa durch Themen wie Learning Analytics, KI-basierte Lernsysteme oder generative Modelle. Die moderate Erholung 2025 verweist auf eine mögliche Neuordnung der semantischen Zentren und bleibt wegen des noch unvollständigen Jahres vorsichtig zu interpretieren. Die quartilsbasierten Referenzlinien ($Q_1 \approx 0{,}9686$, $Q_3 = 1{,}0000$) und die Fatigue-Schwelle von $0,96$ helfen dabei, Übergänge zwischen Verdichtungsphasen und stärkerer Fragmentierung zu markieren. Sie dienen hier als Einordnungshilfe für die Jahrgänge, nicht als eigenständiger Qualitätsbeweis der algorithmischen Clusterbildung.

Die ergänzende Darstellung der Abweichung $\Delta SC_n$ (\hyperref[fig:delta-silhouette]{Abb.~\ref{fig:delta-silhouette}}) führt eine Sensitivitätsperspektive auf die Clusterkohärenz ein. Während der Silhouette-Score die geometrische Trennschärfe der Cluster bewertet, zeigt $\Delta SC_n$, wie stark die relative Kohärenz eines Jahres unter Berücksichtigung des jeweiligen Volumens ($n/\max(n)$) von einem Referenzwert abweicht. Positive Werte verweisen auf Jahre, in denen die semantische Kohärenz im Verhältnis zur Fallzahl vergleichsweise hoch ausfällt. Für die Jahre 2010–2017 spricht dies eher für kleine, fokussierte Felder als für eine allgemeine Stabilität des Gesamtfeldes.

Ab 2018 pendelt $\Delta SC_n$ um den Median, was eine weitgehend proportionale Entwicklung von Korpusgröße und thematischer Konsistenz signalisiert. Auffällig sind die negativen Ausschläge der Jahre 2023–2025. Sie verweisen auf Konstellationen, in denen hohe Publikationsvolumina mit einer strukturellen Reorganisation der thematischen Landschaft einhergehen. Die starke negative Abweichung 2024 ($\Delta SC_n < -0{,}8$) verdeutlicht diese Drift besonders klar: Die semantische Dichte kann mit dem Wachstum des Feldes nicht im gleichen Maße Schritt halten. Methodisch weist dies auf Übergangszonen hin, in denen bestehende Clusterzentren an Stabilität verlieren und neue semantische Schwerpunkte entstehen.
