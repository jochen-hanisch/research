...
### 4.2.4 Webcam-basiertes Eye-Tracking und LLM-gestützte Codierung [@hanisch-johannsen_wirkgefuge_2025-1] {#sec:EyeTracking}
...
Die korrelativen Visualisierungen ergänzen diese Clusteransicht um eine feinere Beziehungsperspektive zwischen Forschungsunterfragen (FU$_{1}$–FU$_{7}$), Kategorien, Indizes und Suchbegriffen. Methodisch handelt es sich nicht um eigenständige Erklärmodelle, sondern um Strukturbilder, die Richtung, Stärke und Verteilung semantischer Relationen sichtbar machen. Der Schwerpunkt liegt auf Mustererkennung und auf der Frage, ob die deduktiv definierten Ebenen in sich plausibel anschließen; hohe absolute Korrelationswerte sind dafür weder Voraussetzung noch Ziel. Die vollständigen Korrelationsmatrizen sind im \hyperref[sec:A-4]{Anhang „Korrelationsatlas“} dokumentiert [@hanisch-johannsen_wirkgefuge_2025-2].
...
- **Triangulation:** Kongruenzen zwischen Blickverhalten und Selbstauskunft stützen die Wirksamkeit der UI; Divergenzen markieren mögliche Interface‑ oder Passungsbrüche und fließen in die Diskussion ein [@hanisch-johannsen_wirkgefuge_2025-1; @hanisch-johannsen_wirkgefuge_2025]. Subgruppenanalysen (v.a. Jahrgänge sowie Teilnahme am Eye‑Tracking: Ja/Nein) liefern dafür zusätzlichen Kontext.
...
Für den Vergleich wurden im Eye‑Tracking pro Jahrgang jeweils acht Personen berücksichtigt ($n=24$ insgesamt); damit liegen für alle drei Kohorten gleich große, auf AOI-Ebene vergleichbare Teilstichproben vor, auch wenn die Repräsentativität zwischen den Jahrgängen unterschiedlich ausfällt [@hanisch-johannsen_wirkgefuge_2025-1]. Inhaltlich konzentriert sich die Auswertung auf die Stimuli `F10-S3` (Lernplan/Kompetenzen; Verständlichkeit), `F11-S3` (weiterführende Quellen; Auffindbarkeit und Link-Salienz) und `F14-S3` (Lernmaterial/Sicherheit; Salienz sicherheitsrelevanter Hinweise) sowie auf die zugehörigen jahrgangsbezogenen Gesamt-Visuals aus Heatmap, Viewmap und Fog‑View [@hanisch-johannsen_wirkgefuge_2025-1]. Die drei Stimuli wurden gewählt, weil sie unterschiedliche, für das LMS zentrale Funktionsbereiche abdecken: Orientierung im Kompetenz- und Lernverlauf, Sichtbarkeit weiterführender Angebote und Wahrnehmung sicherheitsrelevanter Materialien. Damit wird die Triangulation an drei methodisch unterschiedlichen sowie funktional komplementären Interfacesituationen durchgeführt, ohne den gesamten Bildkorpus im Detail erneut berichten zu müssen.

Die Triangulation erfolgt fallbezogen über dieselben Funktionsbereiche: Die Blickmuster aus `F10-S3`, `F11-S3` und `F14-S3` werden mit den itemweisen Umfragekennzahlen zu Struktur und Verständlichkeit, zur Auffindbarkeit weiterführender Angebote sowie zur Material- und Sicherheitswahrnehmung abgeglichen, jeweils nach Jahrgang und für die Gesamtstichprobe der UM1 [@hanisch-johannsen_wirkgefuge_2025]. Zusätzlich werden, soweit analytisch sinnvoll, die Umfragewerte der Teilgruppe mit Eye‑Tracking-Teilnahme den Werten der übrigen Teilnehmenden gegenübergestellt. So lässt sich prüfen, ob hohe Selbstbewertungen mit sichtbarer Aufmerksamkeit auf den korrespondierenden Interface-Zonen zusammenfallen oder ob sich systematische Abweichungen zwischen Urteil und Blickverhalten zeigen [@hanisch-johannsen_wirkgefuge_2025-1; @hanisch-johannsen_wirkgefuge_2025]. Die methodische Funktion dieser Kopplung liegt darin, technisch‑gestalterische Auffälligkeiten über eine zweite Datenspur auf Plausibilität, Passung und mögliche Widersprüche zu prüfen.

Eine systematische Reflexion der Eye-Tracking-Daten [@hanisch-johannsen_wirkgefuge_2025-1] erfolgt im Rahmen der methodenkritischen SWOT-Analyse (Abschnitt 4.5.1), um Potenziale und Limitationen der empirischen Erhebung im Zusammenspiel mit generativen Sprachmodellen (LLM) zu analysieren.
...
Zu den methodischen Stärken der Arbeit gehört der forschungsfragengeleitete Ansatz mit seiner systemischen Perspektive. Er erlaubt es, Literaturarbeit, Simulation und Eye-Tracking [@hanisch-johannsen_wirkgefuge_2025-1] mit neueren, rechnergestützten Verfahren wie LLM-/Embedding-Auswertungen und Python-basierten Analyseschritten in einem gemeinsamen Design zusammenzuführen.
