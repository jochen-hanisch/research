...
Die hier entwickelten theoretischen Elemente werden in \hyperref[sec:6-3-1]{Kapitel 6.3.1} als Interdependenzrahmen verdichtet und in \hyperref[sec:7-0]{Kapitel 7} manifestartig operationalisiert.
...
### 2.2.1 Bedürfnisse als Grundlage {#sec:2-2-1}
...
### 2.2.2 Emotionen als Vermittler {#sec:2-2-2}
...
### 2.2.3 Neugier als Konzept {#sec:2-2-3}
...
### 2.2.4 Persönliche Ereignisse und Lernerfahrungen {#sec:2-2-4}
...
### 2.2.5 Dispositionale Merkmale {#sec:2-2-5}
...
## 2.3 Systemische Dynamik des digitalen Bildungswirkgefüges {#sec:2-3}
...
### 2.3.1 Das Modell als dynamisches System {#sec:2-3-1}
...
### 2.3.2 Regeneration, Störung und Wirkungskurven in LMS {#sec:2-3-2}
