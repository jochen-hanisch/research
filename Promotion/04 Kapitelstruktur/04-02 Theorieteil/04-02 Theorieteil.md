...
Für die Dissertation hat diese Herleitung eine doppelte Funktion. Zum einen wird Kompetenz damit nicht als isolierter Output einzelner Lernschritte geführt, sondern als wirkungsbezogene Leitgröße des Bildungswirkgefüges. Zum anderen wird verständlich, weshalb in der späteren Modellierung und Simulation nicht einfach Kompetenz im Sinne eines stabilen Punktwertes „gemessen“ werden kann. Modelliert werden vielmehr Veränderungsverläufe, Sensitivitäten, Kopplungen und Kippstellen, über die sich Kompetenzentwicklung nur vermittelt erschließen lässt. Bildung begründet dabei den normativen Horizont dieser Analyse, Digitalität die Bedingungen des gegenwärtigen Bildungsraums, und Kompetenz markiert jene theoretische Leitgröße, an der sich zeigt, ob die Kopplung von pädagogischer Gestaltung, technischer Infrastruktur und subjektiven Voraussetzungen tatsächlich in tragfähige Lern- und Entwicklungsverläufe übergeht. Damit ist zugleich die Brücke zu den Forschungsunterfragen gelegt. FU$_{2}$ richtet sich auf Effekte im Erleben und Handeln, FU$_{4}$ auf die zugrunde liegenden Mechanismen, und FU$_{6}$ auf die Frage, wie ein LMS als Kompetenzerwerbssystem unter Bedingungen dieser Unschärferelation theoretisch plausibilisiert werden kann.
...
Die medienpädagogische Rahmung wird in dieser Arbeit korpusbasiert entlang jener Schlagwortachsen geführt, die in den Analysen 1. Ordnung wiederkehrend als Begründungs- und Evidenzspuren auftauchen: `Bildungstheorien` (Begriffsrahmen und epistemische Setzungen), `Lernsystemarchitektur` (Struktur- und Medialitätsbedingungen des LMS), `Technologieintegration` und `Systemanpassung` (Einbettung, Stabilisierung, Kontextabhängigkeit), `Lehr- und Lerneffektivität` und `Bewertungsmethoden` (Wirkannahmen, Mess- und Indikatorlogiken), `Kollaboratives Lernen` (Interaktions- und Regulationsformen), `Datenschutz und IT-Sicherheit` (normative und governancebezogene Randbedingungen), `Krisenreaktion im Bildungsbereich` (Beschleuniger und Sichtbarmacher von Steuerungsüberhängen) sowie `Forschungsansätze` (methodische Zugriffskontraste und Evidenzlogiken). Diese Achsen werden im Theorieteil als heuristische Ordnung genutzt, um wiederkehrende Muster und Unterschiede im Korpus sichtbar zu machen und so Tool‑Determinismus sowie unmittelbare Wirksamkeitsbehauptungen begrifflich zu begrenzen. [@dittler_technologiedefizite_2009; @luhmann_technologiedefizit_1982; @bilstein_arbeit_2020]

Im Korpus zeigt sich erstens eine deutliche Abkehr von einer „Feature‑Logik“. Digitale Lernräume erscheinen als sozial‑didaktisch gerahmte Möglichkeitsräume, deren Wirkungen über Regulation, Rückkopplung, Deutung und organisationale Anschlussfähigkeit emergieren. [@mayrberger_mediendidaktik_2023; @mayer_pragmatismus_2004; @vuorenmaa_how_2024; @rieser_gemeinsame_2025]

Unterschiedlich ist zweitens, auf welcher Ebene diese Rahmung verhandelt wird und wie Evidenz hergestellt wird. Einige Beiträge arbeiten auf der Mikroebene konkreter Lernsettings, etwa zu Ko‑/Shared Regulation in CSCL sowie zu Reflexions- und Motivationsrahmen. Andere konzentrieren sich auf die Mesoebene organisationaler Einbettung und Stabilisierung, wieder andere auf Makro- und Governance-Randbedingungen wie Datenschutz, Sicherheit und Krisenreaktion. Damit verschiebt sich auch der Status von Wirkbehauptungen und die Art, wie sie abgesichert werden. [@vuorenmaa_how_2024; @andrayani_role_2025; @kittel_verhaltensnormen_2019; @faschingbauer_digitale_2022; @paulus_aus_2021]

Für den Theorieteil bedeutet das erstens, dass `Bildungstheorien` als Begründungsebene fungieren, auf der digitale Bildungsräume überhaupt als Bildungsräume beschreibbar werden. Wiederkehrend ist hier die Kopplung von Wirkannahmen an soziale Regulation, Reflexivität und relationale Steuerung. Je nach Beitrag verschieben sich die bevorzugten Mechanismen, etwa Gruppenregulation, Reflexionsverfahren oder Motivationsmodelle, und damit auch die pädagogischen Stellschrauben, die plausibilisiert werden. [@vuorenmaa_how_2024; @andrayani_role_2025; @rieser_gemeinsame_2025]

Zweitens rahmen `Lernsystemarchitektur`, `Technologieintegration` und `Systemanpassung` die Frage, wie digitale Lernräume als strukturierte Umgebungen entstehen. Plattformnutzung wird wiederkehrend als Einbettungs- und Passungsleistung rekonstruiert, didaktisch, organisational und technisch. Wirkungserwartungen bleiben dabei kontingent und empirisch irritierbar. Je nach Beitrag liegt der Schwerpunkt eher auf infrastruktureller Stabilisierung, organisationaler Implementationslogik oder didaktischer Feinsteuerung. Diese Perspektive ist kompatibel mit der in \hyperref[sec:Technologiedefizit]{Abschnitt~\ref{sec:Technologiedefizit}} entwickelten Begrenzung von Steuerungsversprechen und trägt den Übergang in die dynamische Modelllogik von \hyperref[sec:SystemischeDynamik]{Abschnitt~\ref{sec:SystemischeDynamik}}. [@makwasha_documenting_2025; @hubener_trialogische_2025; @di_bari_remote_2025; @biel_plattformubergreifendes_2025; @dittler_technologiedefizite_2009; @bilstein_arbeit_2020]

Eine konkrete, medienpädagogisch anschlussfähige Ausformulierung dieser didaktischen Einbettung liefern @kotitschke_moodle_2026 mit der „AVIVA+ Moodle-Matrix“. Moodle wird dort als prozessualer Lernraum verstanden, dessen Qualität über die Orchestrierung von Lernphasen, Sozialformen und Rückkopplungspunkten entsteht. Der Beitrag ist vor allem deshalb interessant, weil er diese Rahmung als handhabbare Heuristik operationalisiert und Einbettung als lehrseitige Verantwortungsstruktur beschreibt. Gemeint sind Prozesskohärenz, diagnostische Deutung von Datenspuren und die Übersetzung von Rückmeldungen. Damit ist zugleich die Wirkdimension Lernort‑Kohärenz und Transfer adressiert, weil didaktische Orchestrierung und Prozesskohärenz die Anschlussfähigkeit zwischen Lernraum, Aufgabenpraxis und Kompetenzzuschreibung stützen. [@kotitschke_moodle_2026]

Drittens machen die Achsen `Lehr- und Lerneffektivität` und `Bewertungsmethoden` sichtbar, dass Effektbehauptungen im Korpus fast immer an Mess- und Übersetzungspraktiken gebunden sind. Der Theorieteil muss deshalb klären, wie Indikatoren, Diagnostik und Evaluation als modellabhängige Praxisformen zu lesen sind, damit Kennzahlen nicht als Ersatz für begrifflich begründete Wirkmodelle fungieren. [@niegemann_technologiegestutztes_2020; @huber_diagnostik_2023; @huber_qualitat_2023; @dittler_technologiedefizite_2009]

Viertens wird über `Kollaboratives Lernen` und quer dazu über Feedback- und Regulationslogiken die soziale Seite digitaler Lernräume ausdifferenziert. Wiederkehrend ist die Annahme, dass Wirkung im digitalen Raum wesentlich über Ko‑/Shared Regulation, Aufgabenstruktur und Rückkopplung plausibilisiert wird. Je nach Beitrag liegt der Fokus stärker auf Gruppenprozessdynamiken, auf artefaktvermittelter Kollaboration oder auf didaktischen Feedbackdesigns. Damit verschiebt sich zugleich, welche Formen von Interaktion und Kommunikation als primäre Wirkmechanismen gelten. [@vuorenmaa_how_2024; @rieser_gemeinsame_2025; @andrayani_role_2025]

Fünftens markieren `Datenschutz und IT-Sicherheit` sowie `Krisenreaktion im Bildungsbereich` Randbedingungen, die in den Analysen als Governance- und Vertrauensdimensionen auftauchen: Sicherheit, Datenschutz und institutionelle Krisenlagen wirken als Kontextfaktoren, die Akzeptanz, Belastung und organisatorische Steuerung beeinflussen und damit indirekt die Bedingungen von Lernräumen mitprägen. [@kittel_verhaltensnormen_2019; @faschingbauer_digitale_2022; @paulus_aus_2021]

Schließlich fungiert `Forschungsansätze` im Korpus als Hinweis darauf, dass die Literatur unterschiedliche Evidenzlogiken kombiniert (z. B. experimentelle Designs, Reviews, qualitative Rekonstruktionen). Für den Theorieteil folgt daraus, dass Wirkannahmen als Kausalpläne unter Ungewissheit zu führen sind und dass die Argumentation über kontrollierte Plausibilisierung und dokumentierte Evidenzlinien stabilisiert wird, statt in einem Verfahren „aufzugehen“. [@bilstein_arbeit_2020; @dittler_technologiedefizite_2009; @voelkle_one_2012]

### 2.3.1 Medienpädagogik als Disziplin und Perspektive {#sec:Medienpaedagogik-Disziplin}
\label{term:medienpaedagogik-disziplin}

Medienpädagogik entfaltet eine epistemische Perspektive auf digitale Räume, indem sie nicht „die Technik“, sondern die Bedingungen von Bildung unter Medialität in den Blick nimmt. Die Korpusbelege zeigen übereinstimmend, dass Lernerfolg in digitalen Settings nicht durch Plattformfunktionen erklärt werden kann. Plausibel wird er vielmehr über soziale und kognitive Regulations‑ und Reflexionsprozesse. Die Akzentsetzungen unterscheiden sich jedoch. @vuorenmaa_how_2024 arbeiten die Dynamik geteilter und kooperativer Regulation in CSCL‑Settings heraus. @andrayani_role_2025 koppeln Kollaboration an strukturierte Reflexion und Motivation und fokussieren damit stärker didaktische Rahmungen und individuelle Anschlussfähigkeit. @schulz_game_2024 und @rieser_gemeinsame_2025 verknüpfen Peer‑Tutoring‑Arrangements mit Selbstregulationsmodellen und markieren den Übergang zwischen individueller und sozialer Steuerung. Zusammen begrenzen diese Perspektiven technologische Determinantenannahmen, indem sie Wirkung als relational, prozessual und deutungsabhängig konturieren.
...
@mayer_pragmatismus_2004 formulieren didaktische Prinzipien auf der Grundlage einer pragmatistischen Handlungs- und Erfahrungstheorie. @mayrberger_mediendidaktik_2023 hebt Bedingungen hervor, unter denen Handlungsfähigkeit im digitalen Hochschulumbruch gestärkt wird. Gemeinsam ist diesen Zugängen die Abwehr technikdeterministischer Wirkversprechen zugunsten einer reflexiven, auf Anschlusskommunikation und Ermöglichung gerichteten Mediendidaktik. Die Schwerpunktsetzung fällt dennoch unterschiedlich aus. @mayer_pragmatismus_2004 konturieren stärker Prinzipien didaktischer Integration, @mayrberger_mediendidaktik_2023 akzentuiert stärker Agency‑, Partizipations- und Rahmungsbedingungen in institutionellen Umbruchsituationen. [@mayer_pragmatismus_2004, Seite 2; @mayrberger_mediendidaktik_2023, Seite 127]
...
Damit wird Digitalität als Transformationsbedingung beschrieben, unter der Handlungsfähigkeit als Zielgröße pädagogischer Gestaltung neu bestimmt werden muss. @mayrberger_mediendidaktik_2023 fragt vor diesem Hintergrund, „unter welchen persönlichen und organisationalen Bedingungen eine stetige Handlungsfähigkeit aller beteiligter Akteur:innen … im Zuge der digitalen Transformation der Hochschulbildung … gestärkt und gefördert werden könne“. [@mayrberger_mediendidaktik_2023, Seite 127]

Für den hier verwendeten Begriff des digitalen Bildungsraums ist dabei entscheidend, dass Digitalität nicht von Bildung getrennt geführt wird. Sie verändert die Bedingungen, unter denen Teilhabe, Reflexion, Orientierung und Handlungsfähigkeit pädagogisch möglich werden, und greift damit direkt in die Gestalt von Bildungsprozessen ein. Bildungstechnologie ist in dieser Perspektive nur dann anschlussfähig, wenn sie diese Veränderung nicht auf Technikfunktionen verkürzt, sondern als Umformung von Bildungsbedingungen begreift. [@huber_bildung_2023, Seiten 59-66; @mayrberger_mediendidaktik_2023, Seite 127; @kerres_bildung_2020, Seiten 1 und 7]
...
Der Bildungstechnologie‑Abschnitt arbeitet Technik als strukturbildende Bedingung von Bildungsprozessen heraus, in der die Werkzeugmetapher als Teilaspekt mitgeführt wird. @benner_technik_2004-1 rekonstruiert diese Debatte ideen‑ und begriffsgeschichtlich und markiert, dass Technik weder ignoriert noch „einfach vom Werkzeug her zu verstehen“ sei [@benner_technik_2004-1, Seite 992].

Zugleich bleibt pädagogische Struktur eine Gestaltungs‑ und Verständigungsleistung. @kerres_bildung_2020 kritisiert die verbreitete Tendenz, Wirkungen des Digitalen als selbstverständlich zu setzen und dabei Gestaltungsoptionen zu verdecken. Unter digitalen Bedingungen bleibt soziale Beziehung in Lernmaterialien zudem „besonders schwierig zu erzeugen“. Dadurch wird die Gleichsetzung technischer Codierung und pädagogischer Wirksamkeit begrifflich begrenzt. [@kerres_bildung_2020, Seite 1; @pfannstiel_psychologische_2022, Seite 591]

Damit wird Bildungstechnologie in dieser Arbeit als Übersetzungsleistung konturiert. Technische Möglichkeiten wie Vernetzung, Sichtbarkeit und Daten werden didaktisch so gerahmt, dass Handlungsfähigkeit und Anschlusskommunikation als anschlussfähige Formen plausibel werden. @kerres_bildung_2020 formuliert hierfür eine sozio‑konstruktivistische Alternative, in der Wirkungen des Digitalen als „Ergebnis sozialer Aushandlungsprozesse“ verstanden werden. Medienpädagogisch folgt daraus eine Reflexionspflicht über kulturelle und soziale Implikationen digitaler Medien sowie über deren Funktion. [@kerres_bildung_2020, Seite 7; @mayrberger_mediendidaktik_2023, Seite 127; @mayer_pragmatismus_2004, Seite 2]
...
Die in \hyperref[sec:Paradigmen-Modellparameter]{Abschnitt~2.2.7} eingeführten Modellparameter werden in diesem Kapitel als arbeitsfähige Größen weitergeführt. Externe Steuerung wird über Regel- und Eingriffsdruck greifbar, etwa in Pflichtsequenzen, Freischaltlogiken, Fristregimen oder eng geführten Prüfungsarchitekturen. Im Modell wirkt sie als Größe, die Wahlspielräume verengt oder öffnet und damit beeinflusst, wie stark Lernverläufe an vorgegebene Abläufe gebunden bleiben. Rückkopplungsdichte wird über Frequenz, Vielfalt und Reichweite von Feedbackkanälen indikatorisch lesbar, etwa über automatische Rückmeldungen, lehrseitiges Feedback, Peer-Feedback oder sichtbare Arbeitsstände. In der Simulation wirkt sie auf die Geschwindigkeit und Stabilität, mit der Lernende Anschluss finden, Kurskorrekturen vornehmen und nach Störungen wieder in tragfähige Verläufe zurückkehren.

Kontextsensitivität wird dort greifbar, wo ein Arrangement auf situative, personale und organisationale Veränderungen reagiert, etwa über flexible Fristen, alternative Bearbeitungswege, Unterstützungsangebote oder unterschiedliche Rollenlogiken. Im Modell bestimmt sie, wie stark Kontextwechsel, persönliche Ereignisse oder verschiedene Ausgangslagen den weiteren Verlauf umlenken können. Irritationsintensität wird davon getrennt geführt. Gemeint ist die Stärke fachlicher, sozialer oder organisatorischer Unterschiede, die Reorganisation anstoßen. Indikatorisch zeigt sie sich etwa in Widerspruch, Perspektivwechsel, Problemkomplexität oder konfliktträchtigen Rückmeldungen. In der Simulation erscheint sie als Impulsgröße, die Verläufe beschleunigen, destabilisieren oder neu ausrichten kann. Das Verhältnis von Offenheit und Sequenzierung beschreibt, wie eng Navigation und Bearbeitung vorgegeben sind. Die Rolle von Evaluation markiert, welche Funktion Bewertung im Lernprozess übernimmt. Beides prägt im Modell, welche Handlungsoptionen sichtbar werden, wann Kippstellen erkennbar sind und wie Kompetenzentwicklung als Verlauf plausibilisiert werden kann. Die methodische Ausarbeitung dieser Größen erfolgt in \hyperref[sec:Simulation-Kompetenzentwicklung]{Abschnitt~4.4}. [@hanisch-johannsen_simulation_2025; @theis_grundlagen_2002, Seite 1]

Der Status des Modells ist dabei epistemisch begrenzt: Es wird als Beobachtungsform zweiter Ordnung geführt, die Beobachtungen und Kausalpläne im Feld (z. B. Wirksamkeitsannahmen über LMS‑Architekturen) ordnet und irritierbar macht; Prognoseaussagen erhalten den Status kontingenter Kausalpläne und werden über dokumentierte Evidenzlinien geprüft. [@baraldi_operationbeobachtung_2019]
Wahrscheinlichkeitsmodulation bezeichnet in dieser Arbeit die Veränderung von Irritations‑ und Anschlussbedingungen in strukturell gekoppelten Lern‑ und Organisationszusammenhängen; Kompetenzentwicklung wird als Plausibilisierung von Kompetenzzuschreibungen im Vollzug solcher Anschlusskommunikationen geführt.
...
\hyperref[sec:SystemischeDynamik]{Abschnitt~\ref{sec:SystemischeDynamik}} führt den Übergang von Begriffen zu dynamischen Modellannahmen, indem Bildungswirkungen als zeitliche Kopplungen geführt werden (Rückkopplung, Regeneration, Störung). Das Modell rahmt damit Wirkungen als relational und nicht‑linear. [@dittler_technologiedefizite_2009, Seite 78]
