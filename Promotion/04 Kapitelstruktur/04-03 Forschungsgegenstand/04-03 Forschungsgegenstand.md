...
Für die vorliegende Dissertation sind diese Ergebnisse als Vorbefunde bedeutsam, weil sie Hinweise darauf gaben, welche Faktoren beim Aufbau des Moodle besonders berücksichtigt werden mussten. Sichtbarkeit und Verfügbarkeit von Ergebnissen, die Wahrnehmbarkeit von Struktur sowie die tatsächliche Möglichkeit zu kollaborativer Interaktion erwiesen sich dabei als konstruktiv relevante Gesichtspunkte [@hanisch_nachhaltiges_2017, Kapitel 3.4; @hanisch_nachhaltiges_2017, Kapitel 3.5].
...
in \hyperref[fig:fg-organisationsarchitektur-lms]{Abbildung~\ref{fig:fg-organisationsarchitektur-lms}} organisiert.
...
Die folgende Abbildung dokumentiert die operativen Rahmenbedingungen des Wirkgefüges. Sie zeigt, welche standardisierte Kursstruktur Lernhandlungen, Navigation und Rückkopplung im System technisch stützt. Die Darstellung stammt aus der eigenen Moodle-Instanz, die als technisches Fundament des hier beschriebenen Learning Management Systems dient.
...
Für die Einführung werden Moodle-Forum und statische Textseiten eingesetzt, weil sie Orientierung und Verbindlichkeit schnell sichtbar machen. Das Forum dient als Ankündigungskanal und trennt einseitige Information von Diskussion. Textseiten halten die zentralen Orientierungstexte dauerhaft auffindbar, ohne dass die Navigation überladen wird. Damit wird eine Grundbedingung der weiteren Kurslogik gesetzt, nämlich dass Erwartungen, Zuständigkeiten und Wege der Kommunikation im Lernraum explizit geführt werden (Abschnitt~\hyperref[sec:DidaktischeVerortung]{3.1.2}).

**Limitationen und Weiterentwicklungspotenziale**
Eine Limitation besteht darin, dass Einführungs- und Rahmungstexte leicht übersehen werden, insbesondere bei hoher Informationsdichte. Wenn die Einführung nur als statische Information erscheint, kann sie passiv gelesen oder übersprungen werden. Sinnvoll sind daher kurze, verpflichtungsarme Interaktionen, etwa ein kurzes Onboarding-Quiz oder eine Mini-Abfrage, die Orientierung, Erwartung und Selbstverortung tatsächlich auslösen. Aus theoretischer Perspektive geht es hier um die Balance zwischen Struktur und Selbststeuerung, also um die Frage, welche Anschlussbedingungen gesetzt werden, ohne Autonomie zu unterlaufen (Abschnitt~\hyperref[sec:SystemischeDynamik]{2.5}).
...
Die Kursstruktur setzt die Containerlogik zudem konkret in typische Moodle‑Aktivitäten um.
...
**Technische Umsetzung in Moodle**
Als Ressourcencontainer werden Moodle-Verzeichnisse, Dateilisten und Link-Sammlungen genutzt, weil sie Materialien übersichtlich bündeln und leicht aktualisierbar halten. Im Unterschied zu Foren oder Wikis bleibt die Navigation hier stärker hierarchisiert, was gerade bei wachsenden Materialbeständen die Wiederauffindbarkeit stabilisiert. Das ist im Untersuchungsfall relevant, weil Verfügbarkeit und zeitnahe Zugänglichkeit von Ergebnissen und Materialien als kritische Bedingung für nachhaltige Wissensprozesse sichtbar wurden (Abschnitt~\hyperref[sec:Entstehung-Konzept]{3.2.1}).

**Limitationen und Weiterentwicklungspotenziale**
Eine Limitation ist Materialüberfrachtung. Wenn zu viel abgelegt wird, sinken Übersicht und Nutzung, der Container wird zur Ablage. Dagegen helfen klare Kuratierungsregeln, regelmäßige Ausdünnung und die Kopplung an Aufgaben, etwa über direkte Verlinkungen aus Aufgabenstellungen. Ergänzend sind interaktive Formate möglich, etwa kommentierbare Ressourcen oder Peer-Empfehlungen, die Auswahl und Bewertung als Lernhandlung sichtbar machen. Damit wird der Ressourcencontainer stärker an die Trajektorienlogik angeschlossen, weil Materialien nicht nur bereitgestellt, sondern in Nutzungsketten integriert werden (Abschnitt~\hyperref[sec:Systemisch-konstruktivistische-Theorie]{2.2.2}).

**Umsetzung in NFS‑H‑01**
Im Kurs NFS‑H‑01 beispielsweise wird diese Funktion bewusst als „Grundlagenraum“ realisiert. Die bereitgestellten Materialien sind nicht primär auf eine einzelne Aufgabe zugeschnitten. Sie sind auf den Einstieg in die Ausbildung und auf wiederkehrende, kursübergreifende Bedarfe ausgerichtet (z. B. Handbuch Berufsausbildung, Ausrüstungsverzeichnis). Damit wird in der ersten Woche eine gemeinsame Wissens- und Erwartungsbasis erzeugt, die den unterschiedlichen Vorwissensständen der Lernenden Rechnung trägt und zugleich Such- und Orientierungsaufwand reduziert. Der Ressourcencontainer übernimmt hier eine doppelte didaktische Entlastungsfunktion. Er senkt kognitive Last, indem grundlegende Informationen nicht verstreut, sondern systematisch an einer Stelle gebündelt werden. Er erhöht Anschlussfähigkeit, indem er als „stabiler Bezugspunkt“ in der weiteren Ausbildung wieder aufgerufen werden kann. Die ergänzenden Hintergrundinformationen (z. B. zum „Kreis Stenkelfeld“ als Rahmenerzählung) sind dabei nicht bloß dekoratives Beiwerk. Sie sind ein strukturbildendes Element. Sie schaffen ein gemeinsames Referenzsystem, an das spätere Fall- und Einsatzlogiken anschließen können, ohne dass diese Anschlussstellen jeweils neu begründet werden müssen.

**Didaktische Besonderheiten/Herausforderungen**
Der Ressourcenbereich entfaltet seine Wirkung vor allem dann, wenn er neben Literatur auch arbeitspraktische Vorlagen enthält (z. B. Quellencheck, Zitier-Quickguide, Muster für Ergebnissicherung) und damit die Brücke zwischen „Material liegt bereit“ und „Material wird lernwirksam genutzt“ schließt. Ohne diese Übersetzung bleibt der Container häufig informativ, aber nicht handlungsleitend.
...
**Technische Umsetzung in Moodle**
Die Nutzung von Moodle-Foren, Linklisten, Datenbanken und kommentierten Sammlungen als technische Formate ermöglicht flexible, dynamisch erweiterbare und partizipativ gestaltbare Strukturen. Im Vergleich zu statischen Ressourcenverzeichnissen bieten diese Formate die Möglichkeit, dass Lernende und Lehrende gemeinsam Inhalte kuratieren, kommentieren und aktualisieren. Die Integration von Peer-Review- oder Bewertungsfunktionen kann die Qualitätssicherung unterstützen.

**Limitationen und Weiterentwicklungspotenziale**
Limitationen zeigen sich vor allem dort, wo Aufnahme und Bewertung von Quellen nicht geregelt sind. Ohne Kriterien drohen Überfrachtung, Unübersichtlichkeit und Unsicherheit über Validität und Relevanz. Weiterentwicklung braucht deshalb transparente Verfahren, etwa kuratierte Listen, Peer-Review oder redaktionelle Rollen, ergänzt um Kommentierung und Bewertung. Didaktisch gewinnt der Container, wenn Quellenarbeit als explizite Handlung in Aufgaben eingebunden wird und damit nicht nebenbei passiert, sondern als Teil von Begründung und Transfer sichtbar wird (Abschnitt~\hyperref[sec:Grundkonstruktion]{3.4.1} sowie Abschnitt~\hyperref[sec:Bildungswiss-Verortung]{2.2}).
...
**Funktion im Gesamtsystem**
Der Container weiterführende Quellen trägt zur Erweiterung des individuellen Lernhorizonts bei und bewirkt zugleich eine strukturelle Voraussetzung für eine differenzierte Leistungsbewertung im Sinne evidenzbasierten Handelns.
...
Als Analyseschritte folgten die folgenden Schritte.
...
Ergänzend lässt sich die Struktur der 32 Kurse als mehrdimensionaler Raum der Themenanteile (medizinisch, rettungsdienstlich, bezugswissenschaftlich) visualisieren. \hyperref[fig:fg-kmeans-themenanteile]{Abbildung~\ref{fig:fg-kmeans-themenanteile}} zeigt eine k-means-Clusterlösung im 3D-Raum der Kursanteile; \hyperref[fig:fg-dendrogramm-themenanteile]{Abbildung~\ref{fig:fg-dendrogramm-themenanteile}} ergänzt dies um eine hierarchische Ähnlichkeitsstruktur (Ward-Linkage).
...
\hyperref[fig:fg-aprv-kompetenzbereiche]{Abbildung~\ref{fig:fg-aprv-kompetenzbereiche}} zeigt, bezogen auf den Gesamtumfang der Ausbildung, die in der NotSan-APrV verankerte Kompetenzgewichtung. Die vier Kompetenzbereiche – fachlich (24 %), sozial (15 %), personal (11 %) und methodisch (50 %) – definieren die Zielstruktur beruflicher Handlungskompetenz im Rettungsdienst [@bundesgesundheitsministerium_referentenentwurf_2012, Seite 47]. Der hohe Anteil methodischer Kompetenzen lässt sich als Ausdruck der Bedeutung strukturierter Vorgehensweisen und routinisierter Entscheidungsabläufe lesen. Fachliche, soziale und personale Anteile ergänzen diesen Schwerpunkt um Wissen, Interaktionsfähigkeit und Reflexionsfähigkeit.
