...
Die dort gewonnenen Ergebnisse werden in der vorliegenden Dissertation als Vorbefunde eingeordnet. Sie dienen nicht als Hypothesen dieser Arbeit, sondern als empirischer Ausgangspunkt für die Frage, welche Wirkmechanismen im LMS zur Stabilisierung oder Entkopplung von Lernprozessen beitragen. Bereits die Vorarbeit zeigte, dass die Effekte der betrachteten Faktoren nicht isoliert als Eigenschaft einzelner Variablen verstanden werden können, sondern in ihrer Kopplung mit Aufgabenstruktur, Zeitlogik und Interaktionsarrangements zu betrachten sind.

In der Vorarbeit wurden drei Arbeitshypothesen (RH1-RH3) zu den Einflussfaktoren Zeit, Struktur und Interaktion auf nachhaltiges Wissensmanagement geprüft. Grundannahme war, dass Lernen in der Qualifikation von Notfallsanitäterinnen und Notfallsanitätern autopoietisch und selbstorganisiert verläuft (s. \hyperref[sec:Systemisch-konstruktivistische-Theorie]{Abschnitt 2.2.2}), und dass insbesondere die zeitliche Verfügbarkeit von Lernergebnissen entscheidend für deren nachhaltige Aneignung ist [@hanisch_nachhaltiges_2017, Kapitel 3.4, Abbildung 2].
...
Für die Dissertation folgt daraus die zentrale Forschungslogik, Wirkungen als Ergebnis von Kopplungen im digitalen Lernarrangement zu modellieren. Der analytische Fokus liegt auf den Bedingungen, unter denen die Verschränkung von Zeit, Struktur und Interaktion im LMS ein lernförderliches Wirkgefüge erzeugt.
