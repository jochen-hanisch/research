...
Der interdependente Rahmen bleibt zunächst konzeptuell. Eine ergänzende Perspektive entsteht dort, wo die in \hyperref[sec:Ergebnisse]{Kapitel 5} rekonstruierten Unsicherheiten als Kopplungsphänomene explizit geführt und in eine Zeitlogik übersetzt werden. Die Leitidee ist eine „rechnerische Spur“: Aus Befundmustern werden Unsicherheitsquellen extrahiert, theoriegeleitet gebündelt und im Modell als dynamische Größen fortgeschrieben (vgl. \hyperref[sec:Simulation-Kompetenzentwicklung]{Abschnitt 4.4}).

#todo (#99) revision: Abgrenzung „rechnerische Spur“ vs. Messanspruch schärfen (6.3.1.1)
Diese rechnerische Spur ist als argumentatives Bindeglied zu verstehen: Sie übersetzt die in den Ergebnissen beobachteten Bruchstellen (Orientierung/Handlung/Feedback) in eine formalisierte Dynamiksprache und hält den Status als Modellspur explizit fest [@hanisch-johannsen_simulation_2025]. Damit wird Interdependenz als zeitliche Kopplungsform anschlussfähig und kann in Gestaltungsannahmen (z.B. wo Interventionen eher stabilisieren oder übersteuern) überführt werden.
