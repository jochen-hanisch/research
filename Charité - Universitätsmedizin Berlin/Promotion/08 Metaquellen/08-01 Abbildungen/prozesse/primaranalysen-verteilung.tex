\begin{figure}[H]
    ...
    \begin{tikzpicture}[x=0.12cm, y=0.7cm]
        ...
        \foreach \p/\t/\y/\c in {
            27.8/FU4a/8/ciPositive,
            15.6/FU5/7/ciPrimaryLine,
            14.7/FU3/6/ciPrimaryLine,
            11.5/FU4b/5/ciSecondaryLine,
            10.6/FU2a/4/ciSecondaryLine,
            8.1/FU6/3/ciNeutral,
            7.2/FU1/2/ciNeutral,
            3.4/FU2b/1/ciNeutral,
            1.0/FU7/0/ciNegative}
        {
            % Balken
        ...
        \caption*{\footnotesize Dargestellt ist der prozentuale Anteil der insgesamt 801 Primäranalysen je Forschungsunterfrage; Grundlage sind Einträge mit FU-Tag und auswertbarem \texttt{annote}-Feld im aktuellen Zotero-Export (Stand: 2026-05-06). Die horizontale Balken-Darstellung ist absteigend nach Anteil sortiert, die Achse unten zeigt die Prozentwerte in 5-\%-Schritten.}
