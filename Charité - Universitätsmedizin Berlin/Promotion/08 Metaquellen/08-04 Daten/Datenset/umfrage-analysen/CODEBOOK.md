...
tags: []
---
# Codebook: `UmfrageOnline-Beantwortungen_bereinigt.csv`

## Allgemeines

- **Einheit der Analyse:** einzelne Fragebogenteilnahme (`RespondentID`).
- **Missing Values:** leere Felder (`""`) bedeuten fehlende/keine Angabe.
- **Skalierung:** Die meisten Items sind als ordinaler Likert-Wert `1`–`5` gespeichert (Interpretation der Polung/Anker erfolgt über das Erhebungsinstrument/Fragebogen im Repository bzw. in der Dissertation). Ein Item ist binär (`Ja`/`Nein`).

## Variablen

- `RespondentID`  
  Lokale, nicht rückrechenbare Kennung (`R001` …).
